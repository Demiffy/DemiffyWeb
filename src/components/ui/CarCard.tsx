...
const CarCard: React.FC<CarCardProps> = ({ car, onClick }) => {
  return (
    <div className="bg-primary-color rounded-lg overflow-hidden shadow-lg hover:shadow-cyan-400/50 transition-all duration-300 transform hover:-translate-y-1">
